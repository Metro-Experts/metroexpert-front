              ...
              Expanded(
                child: ListView(
                  children: const [
                    ...
                    SizedBox(height: 35),
                    Customlisttile(
                        classTitle: "Matemática II",
                        studentName: "Beatriz Cardozo"),
                    SizedBox(height: 20),
                    Customlisttile(
                        classTitle: "Matemática IV", studentName: "Hugo Duque"),
                    SizedBox(height: 20),
                    Customlisttile(
                        classTitle: "Estadística", studentName: "Román Chacín"),
                    SizedBox(height: 20),
                    Customlisttile(
                      classTitle: "Bases de Datos I",
                      studentName: "Felipe Escalona",
                    ),
                  ],
                ),
              )

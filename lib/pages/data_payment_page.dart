          ...
          child: ListBody(
            ...
            Container(
              ...
              child: const Column(
                  children: [
                    ListTile(
                      title: Text("Banco:", style: TextStyle(fontWeight: FontWeight.w600)),
                      subtitle: Text("BANCO NACIONAL DE CRÉDITO"),
                    ),
                    ListTile(
                      title: Text("Teléfono: ", style: TextStyle(fontWeight: FontWeight.w600)),
                      subtitle: Text("+58 04241501278"),
                    ),
                    ListTile(
                      title: Text("Cédula: ", style: TextStyle(fontWeight: FontWeight.w600)),
                      subtitle: Text("v.- 30057442"),
                    ),
                    ListTile(
                      title: Text("Asunto: ", style: TextStyle(fontWeight: FontWeight.w600)),
